=== WooTrack ===
Contributors: derwentx
Donate link: https://www.paypal.com/cgi-bin/webscr?cmd=_donations&business=2PF5FGAHHBFU2&lc=AU&item_name=Laserphile%20Developers&currency_code=AUD&bn=PP%2dDonationsBF%3abtn_donateCC_LG%2egif%3aNonHosted
Tags: Woocommerce, StarTrack, Shipping, eServices, API 
License: GPLv3
...
Registers the StarTrack shipping method in WooCommerce using the eServices API
...
2. Shipping methods displayed to customer
