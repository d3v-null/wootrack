...
class Wootrack_OptionsManager {
    ...
    public function settingsPage() {
        if (!current_user_can('manage_options')) {
            wp_die(__('You do not have sufficient permissions to access this page.', 'wootrack'));
        }
        ...
        ?>
        <div class="wrap">
            <h2><?php _e('System Settings', 'wootrack'); ?></h2>
            <table class="form-table"><tbody>
            <tr><td><?php _e('System', 'wootrack'); ?></td><td><?php echo php_uname(); ?></td></tr>
            <tr><td><?php _e('PHP Version', 'wootrack'); ?></td>
                <td><?php echo phpversion(); ?>
                <?php
                if (version_compare('5.2', phpversion()) > 0) {
                    echo '&nbsp;&nbsp;&nbsp;<span style="background-color: #ffcc00;">';
                    _e('(WARNING: This plugin may not work properly with versions earlier than PHP 5.2)', 'wootrack');
                    echo '</span>';
                }
                ?>
                </td>
            </tr>
            <tr><td><?php _e('MySQL Version', 'wootrack'); ?></td>
                <td><?php echo $this->getMySqlVersion() ?>
                    <?php
                    echo '&nbsp;&nbsp;&nbsp;<span style="background-color: #ffcc00;">';
                    if (version_compare('5.0', $this->getMySqlVersion()) > 0) {
                        _e('(WARNING: This plugin may not work properly with versions earlier than MySQL 5.0)', 'wootrack');
                    }
                    echo '</span>';
                    ?>
                </td>
            ...
            <h2><?php echo $this->getPluginDisplayName(); echo ' '; _e('Settings', 'wootrack'); ?></h2>
            ...
            <?php settings_fields($settingsGroup); ?>
                ...
                <p class="submit">
                    <input type="submit" class="button-primary"
                           value="<?php _e('Save Changes', 'wootrack') ?>"/>
                </p>
            </form>
        </div>
        <?php
    ...
    protected function getOptionValueI18nString($optionValue) {
        switch ($optionValue) {
            case 'true':
                return __('true', 'wootrack');
            case 'false':
                return __('false', 'wootrack');

            case 'Administrator':
                return __('Administrator', 'wootrack');
            case 'Editor':
                return __('Editor', 'wootrack');
            case 'Author':
                return __('Author', 'wootrack');
            case 'Contributor':
                return __('Contributor', 'wootrack');
            case 'Subscriber':
                return __('Subscriber', 'wootrack');
            case 'Anyone':
                return __('Anyone', 'wootrack');
        }
        return $optionValue;
    }
